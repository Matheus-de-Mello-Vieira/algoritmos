...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Distância entre os pontos (%.2f,%.2f) e (%.2f,%.2f) é %.4f", pontos[0][0], pontos[0][1],
				pontos[1][0], pontos[1][1],
				Math.sqrt(Math.pow(pontos[0][0] - pontos[1][0], 2) + Math.pow(pontos[0][1] - pontos[1][1], 2)));
		entrada.close();
	}
