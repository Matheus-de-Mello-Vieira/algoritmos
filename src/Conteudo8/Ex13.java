...
public class Ex13 {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 5; i++) {
			...
			int quantidadeDeEleitores = entrada.nextInt(); entrada.nextLine();
			
			System.out.print("Insira a quantidade de mulheres: ");
			int quantidadeMulher = entrada.nextInt(); entrada.nextLine();
			
			System.out.print("Insira a quantidade de homens: ");
			int quantidadeHomem = entrada.nextInt(); entrada.nextLine();
